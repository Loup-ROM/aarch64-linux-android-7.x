...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/matthewdalex/android/uberbuild/out/aarch64-linux-android-7.x/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
